...
// ═══════════════════════════════════════
// ═══════════════════════════════════════
// THEME — pill toggle + view transition wipe
// ═══════════════════════════════════════
...
function toggleTheme() {
  ...
  if (!document.startViewTransition) {
    _applyTheme(next);
    localStorage.setItem('deutschar-theme', next);
    return;
  }
  ...
  document.startViewTransition(() => { _applyTheme(next); localStorage.setItem('deutschar-theme', next); }).ready.then(() => {
...
// Restore on load — read only, no write
(function() {
  const saved = localStorage.getItem('deutschar-theme');
